#!/usr/bin/env python3
"""
EAC-DTW Presentation Generator with Images
Creates a PowerPoint presentation from the research content with embedded images
"""
...
def create_presentation_with_images():
    """Create the EAC-DTW research presentation with images"""
...
Shivam Jha (sj34101n@pace.edu)'''
    ...
    output_path = os.path.join(os.getcwd(), 'EAC_DTW_Presentation_With_Images.pptx')
    prs.save(output_path)
    print(f"Presentation with images saved to: {output_path}")
    return output_path

if __name__ == "__main__":
    create_presentation_with_images()